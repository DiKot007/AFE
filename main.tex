...
\begin{affiliations}
Far Eastern Federal University, Vladivostok, Russky Island, 10 Ajax Bay, 690922, the Russian Federation\\
Institute of Applied Mathematics, Far Eastern Branch, Russian Academy of Science, Vladivostok, Radio 7, 690041, the Russian Federation\\
E-mail Address: nefedev.kv@dvfu.ru
...
\keywords{Ferroelectric materials, Antiferroelectricity, Magnetic materials, Electrical properties and parameters, Electrostatics, Dielectric materials, Transition metal oxides, Coupling constants, Monte Carlo methods, Statistical mechanics models}
...
В последнее время широко исследуется задача рационального дизайна материалов. Например, для полимеров, в рамках грубозернистой модели, с помощью моделирования Монте-Карло, путем расчета диэлектрической проницаемости и петель гистерезиса релаксорных и обычных сегнетоэлектриков, было доказано, что управление региодефектами (нарушениями в регулярности чередования мономеров в цепи) является эффективным способом переключения между релаксорным и обычным сегнетоэлектрическим поведением одного и того же полимера~\cite{guan2025monte}. Для установления критического размера зёрен в рамках AgNbO3 мы обратимся к сведениям из работы ~\cite{zhao2024growth}, где монокристалл продемонстрировал выраженную антисегнетоэлектрическую двойную петлю гистерезиса с высокой плотностью накопления энергии и эффективностью, сопоставимыми с лучшей керамикой.
...
8) Рассчитать наиболее вероятные микросостояния (конфигурации) для каждой точки петли

9) Получить оптимальные параметры $J_{afe}$, $J_{fe}$, $J_{afe}/J_{fe}$, $\mu$, $ N_{MC}$ - число монтекарло шагов 
